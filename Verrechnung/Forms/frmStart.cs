...
namespace Verrechnung
{
    ...
    public partial class frmStart : Form
    {
        ...
        private void frmStart_Load(object sender, EventArgs e)
        {
            ...
            buttons = new Button[] { btnWarenkorb, btnArtikel, btnKunde, btnRechnung, btnUmsatzsteuer, btnStatistik, btnAlleSchlissen, btnProgrammSchlissen };

            int xpos = 0;
            int ypos = 0;
            foreach(Button b in buttons)
            {
                b.Width = this.Width - 17;
